  ...
  <div>
    {#if cards !== null}
      <div class="answer-buttons">
        <button class="btn-answer" on:click={() => { cards = updateState(cards ?? [], 100) }}>Good</button>
        <button class="btn-answer" on:click={() => { cards = updateState(cards ?? [], 66) }}>Decent</button>
        <button class="btn-answer" on:click={() => { cards = updateState(cards ?? [], 33) }}>Bad</button>
        <button class="btn-answer" on:click={() => { cards = updateState(cards ?? [], 0) }}>Worst</button>
      </div>
    {/if}
